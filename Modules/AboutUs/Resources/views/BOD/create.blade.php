...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#bodAddForm').formValidation({
            ...
            $('#bodAddForm').formValidation('revalidateField', 'name');
            $('#bodAddForm').formValidation('revalidateField', 'location');
            $('#bodAddForm').formValidation('revalidateField', 'description');
        })
                ...
                .each(function () {
                    $(this)
                        ...
                        .on('change', function (e) {
                            $('#bodAddForm').formValidation('revalidateField', e.sender.name);
                        });
                });
    });
</script>
...
<div class="box box-primary">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form id="bodAddForm" method="POST" action="{{ route('admin.about-us.bod.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="fileupload fileupload-new" data-provides="fileupload">
                    <div class="fileupload-new thumbnail" style="width: 600px; height: auto;">
                        <img src="{{ asset('uploads/aboutus/bod/default-img.jpg') }}" alt="">
                    </div>
