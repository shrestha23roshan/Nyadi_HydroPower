...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#financialreportAddForm').formValidation({
            framework: 'bootstrap',
            excluded: ':disabled',
            icon: {
            ...
            $('#financialreportAddForm').formValidation('revalidateField', 'title');
        })
    });
</script>
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Create Financial Report</h3>
</div>
    <!-- /.box-header -->
    <!-- form start -->
    <form id="financialreportAddForm" method="POST" action="{{ route('admin.investor-relations.financialreport.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="box-body">
