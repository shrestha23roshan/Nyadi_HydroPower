        ...
        {{-- <ul class="header-dropdown m-r--5 pull-right">
            <ul class="header-dropdown m-r--5">
                <li class="dropdown" style="list-style: none;">
                    <a href="{{ route('admin.media-management.album.photo.create', $album->id) }}"><button class="btn btn-primary">Add New &nbsp;<i class="fa fa-plus"></i></button></a>
                </li>
            </ul>
        </ul> --}}
    </div>
                ...
                <tr>
                    ...
                    <td class="image">
                        @if($record->attachment)
                            <img src="{{ asset('uploads/media-management/album/photos/' . $record->attachment) }}" alt="{{ $record->name }}" width="200">
                        @endif
                    </td>
                    <td>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        swal({
            ...
            $.ajax({
                type: "DELETE",
                url: "{{ url('/admin/media-management/album/photo') }}"+"/"+id,
                dataType: 'json',
