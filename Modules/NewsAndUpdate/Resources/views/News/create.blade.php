...
<div class="box box-primary">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form id="newsAddForm" method="POST" action="{{ route('admin.news.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="box-body">
        @include('layouts.backend.alert')
            ...
            <!--    <input type="text" class="form-control" name="date" id="datepicker" placeholder="Select date." value="{{ old('date')}}">-->
            ...
            <!--            <img src="{{ asset('uploads/news/default-img.jpg') }}" alt="">-->
            <!--        </div>-->
