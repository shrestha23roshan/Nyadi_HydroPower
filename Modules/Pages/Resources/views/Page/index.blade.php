...
<div class="box">
    ...
    {{-- <div class="box-header with-border">
      <a href="{{ route('admin.pages.create') }}"><button class="btn btn-primary">Add New &nbsp;<i class="fa fa-plus"></i></button></a>
    </div> --}}
    <!-- /.box-header -->
    <div class="box-body">
      ...
      <table id="page-table1" class="table table-bordered table-striped ">
        ...
        <tbody id="tablebody1">
            @forelse($parent_pages as $index=>$record)
                <tr>
                    <td>
                        {{ $index+1 }}
                    </td>
                    ...
                    {{-- <td>
                        <a href="{{ route('admin.pages.edit', $record->id) }}" title="Edit page"><button class="btn btn-primary btn-flat"><i class="fa fa-edit"></i></button></a>&nbsp;
  ...
  <div class="box">
        ...
        <div class="box-body">
          ...
          <table id="page-table2" class="table table-bordered table-striped">
            ...
            <tbody id="tablebody2">
                @forelse($child_pages as $index=>$record)
                    <tr>
                        <td>
                            {{ $index+1 }}
                        </td>
