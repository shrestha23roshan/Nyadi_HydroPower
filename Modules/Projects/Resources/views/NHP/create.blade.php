...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#nhpAddForm').formValidation({
            ...
            $('#nhpAddForm').formValidation('revalidateField', 'title');
            $('#nhpAddForm').formValidation('revalidateField', 'description');
        })
                ...
                .each(function () {
                    $(this)
                        ...
                        .on('change', function (e) {
                            $('#nhpAddForm').formValidation('revalidateField', e.sender.name);
                        });
                });
    });
</script>
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Create Nyadi Hydropower project</h3>
</div>
    <!-- /.box-header -->
    <!-- form start -->
    <form id="nhpAddForm" method="POST" action="{{ route('admin.projects.nhp.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="fileupload fileupload-new" data-provides="fileupload">
                    <div class="fileupload-new thumbnail" style="width: 600px; height: auto;">
                        <img src="{{ asset('uploads/projects/nhp/default-img.jpg') }}" alt="">
                    </div>
