...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#progressreportAddForm').formValidation({
            framework: 'bootstrap',
            excluded: ':disabled',
            icon: {
            ...
            $('#progressreportAddForm').formValidation('revalidateField', 'title');
        })
    });
</script>
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Create Progress Report</h3>
</div>
    <!-- /.box-header -->
    <!-- form start -->
    <form id="progressreportAddForm" method="POST" action="{{ route('admin.projects.progressreport.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="box-body">
