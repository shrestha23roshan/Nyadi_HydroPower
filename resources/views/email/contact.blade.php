...
<html lang="en-US">
  <head>
    ...
    <style>
        body {background: #F4F4F4;margin: 0;font-size: 16px;font-family: 'Segoe UI', Tahoma, Verdana, sans-serif;padding: 60px;}
          ...
          <div class="col-12">
              <div class="email-box">
                  <div class="message">
                      ...
                      <h3 class="mt-5">
                          <span class="txt-key font-weight-bolder">Customer FeedBack</span>
                      </h3>
                      <p class="mb-0">Name :  {{ $name }}</p>
                      <p class="mb-0">Email : {{ $email }}</p>
                      <p class="mb-0">Phone No. : {{ $phone }}</p>
