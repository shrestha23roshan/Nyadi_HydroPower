                    ...
                    @if(Request::segment(6) != null && Request::segment(6) == 'create')
                        ...
                        @if($i == 3)
                            @if(array_key_exists('slug', $breadcrumb))
                                ...
                                @if($name == 'album')
                                    <li>
                                        <a href="{!! url('admin/media-management/album/'. $id .'/photo') !!}">{!! ucwords(str_replace('-', ' ', $breadcrumb['name'])) !!}</a>
                                    </li>
                        ...
                        @else
                            @if(array_key_exists('slug', $breadcrumb))
                                ...
                                @if($name == 'album')
                                    <li>
                                        <a href="{!! url('admin/media-management/album') !!}">{!! ucwords(str_replace('-', ' ', $breadcrumb['name'])) !!}</a>
                                    </li>
                                @elseif($name == 'about-us')
                                    <li>
